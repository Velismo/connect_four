document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkBoard() {
        //make const that shows all the wining arrays
        const winningArrays = [
        ...
        //now take all the winning arrays and plug them into the squares
        for(let y = 0; y < winningArrays.length; y++) {
            ...
            if(square1.classList.contains('player-one') &&
                ...
                //if they do, player-one is declared winner
                result.innerHTML = 'Player One Wins!'
                }
                //now check the same for player-two
                else if (square1.classList.contains('player-two') &&
                    square2.classList.contains('player-two') &&
                    square3.classList.contains('player-two') &&
                    square4.classList.contains('player-two')) {
                    //if the do, player-two os declared winner
    ...
    //add an event listener to each square taht will triggers the checkBoard function on click
